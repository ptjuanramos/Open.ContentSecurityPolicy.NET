...
namespace Open.ContentSecurityPolicy.NET.Tests.Directives.Resolver
{
    ...
    public class ConfigurationDirectivesResolverTest
    {
        ...
        {
            List<KeyValuePair<string, string>> keyValuePairs = new List<KeyValuePair<string, string>>(configs);
        ...
        {
            ConfigurationDirectivesResolver directivesResolver = new ConfigurationDirectivesResolver(null);
        ...
        public void GetDirectivesMustReturnEmptyListIfOnlyTheRootCSPElementIsConfigured()
        {
            ...
            ConfigurationDirectivesResolver directivesResolver = new ConfigurationDirectivesResolver(onlyRootConfiguration);
            IEnumerable<Directive> result = directivesResolver.GetDirectives();
